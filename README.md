...
There is no car photography in the catalogue. Every free source measured answers HTTP 200 with one
identical stock image for every vehicle, including cars that do not exist, so each card draws the
